# /www/index.php
Your webserver should be configured to use `/www` as the root directory for requests and should rewrite app URLs to `/www/index.php` while preserving the original path in `REQUEST_URI`.
