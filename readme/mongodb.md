	...
	"mongoDatabases": [
		{
			...
			"encryption": {
				"useEncryption": true,
				"keyVaultNamespace":"DatabaseName.__keyVault",
				"kmsProviders": {
					"gcp": {
...
_masterKeyLocationFilePathName.json_
```json
{
...
_gcpCredentials.json_ this file is generated when creating a service account
```json
{
